...
!
 ...
 Nudge_Model          = .True.
 Nudge_Path           = '/pscratch/sd/k/kaizhang/ndata/eraint_ne30L72/'
...
! change init data
!...................
ncdata = '/global/cfs/projectdirs/m4359/jli628/constance_FC5AV1C-04P2_ne30_ne30_E3SMv1.0_CLIMO_PD_TUNE.cam.i.0000-10-01-00000.nc'
/
EOF
