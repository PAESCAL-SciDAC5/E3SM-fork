...
integer           :: mam_amicphys_precision_opt = 1    ! 1: single call of amicphys using the default floating-point precision,
                                                       ...
                                                       ! For options 2 and 3, the other precision is specified using
                                                       ! the variable mam_amicphys_rpe_nsigbits below.
integer           :: mam_amicphys_rpe_nsigbits = 16    ! when applying pseudo reduced precision (rpe) to amicphys:
                                                       ! floating-point precision expressed as the number of significand bits.
                                                       ! Examples:
                                                       !  32: double precision;
                                                       !  16: single precision;
...
subroutine phys_ctl_readnl(nlfile)
   ...
   namelist /phys_ctl_nl/ cam_physpkg, cam_chempkg, waccmx_opt, deep_scheme, shallow_scheme, &
      ...
      mam_amicphys_precision_opt, mam_amicphys_rpe_nsigbits, &
...
subroutine phys_getopts(deep_scheme_out, shallow_scheme_out, eddy_scheme_out, & 
                        ...
                        mam_amicphys_precision_opt_out, mam_amicphys_rpe_nsigbits_out, &
