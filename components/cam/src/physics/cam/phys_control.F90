...
! Options for coupling the cloud macmic subcyles with rest of model
integer  :: dribble_start_step = 2
integer  :: cld_cpl_opt = 1   !  1: default, i.e., sequential splitting between macmic subcycles and rest of model
                              ! >1: dribbling

! Options for where to apply radheat

integer  :: radheat_cpl_opt = 1    ! default: apply radheat right after radiation_tend
...
subroutine phys_ctl_readnl(nlfile)
   ...
   namelist /phys_ctl_nl/ cam_physpkg, cam_chempkg, waccmx_opt, deep_scheme, shallow_scheme, &
      ...
      cld_cpl_opt, dribble_start_step, radheat_cpl_opt, &
...
subroutine phys_getopts(deep_scheme_out, shallow_scheme_out, eddy_scheme_out, & 
                       ...
                       ,cld_cpl_opt_out, dribble_start_step_out, radheat_cpl_opt_out &
