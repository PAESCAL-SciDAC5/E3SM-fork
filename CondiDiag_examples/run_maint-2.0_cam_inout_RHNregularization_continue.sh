...
# readonly CASE_NAME="EAMv2_fullconvergence_regularizedscheme_10years_instantaneousoutput_sfc_inout_"$RESOLUTION
readonly CASE_NAME="EAMv2_regularizeduniquescheme_nomaxiter_10years_instantaneousoutput_sfc_inout_"$RESOLUTION
...
!--------------------
! h0: monthly mean
! h1: instantaneous output every day; 1 month (30 time slices) per file
